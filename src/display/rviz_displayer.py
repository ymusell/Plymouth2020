...
class Marker_rviz():
	...
	def __init__(self,name,position=(0,0,0), angles=(0,0,0), scale=(1,1,1),m_type=1,color=(1.0,1.0,1.0)):
		...
		if m_type == 10:
			self.marker.mesh_resource = "package://plymouth2020/meshs/"+name+".STL"
...
def sub_gps(data): # Vector3
	...
	# TO see i fthe hange of the sub GPS is good enough, TODO
...
if __name__ == "__main__":
	...
	marker_rudder = Marker_rviz("rudder",(0.15,0,-0.2),(np.pi/2, 0, -np.pi/2),(0.0004,0.0004,0.0004),10,(0.53,0.25,0.11))
	...
	while not rospy.is_shutdown():
		...
		br_wind.sendTransform((x,y,2),(quaternion_from_euler(0,0,psi)),rospy.Time.now(),"wind","map")
