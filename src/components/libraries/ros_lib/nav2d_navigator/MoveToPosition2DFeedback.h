#ifndef _ROS_nav2d_navigator_MoveToPosition2DFeedback_h
#define _ROS_nav2d_navigator_MoveToPosition2DFeedback_h
...
namespace nav2d_navigator
{
  ...
  class MoveToPosition2DFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "nav2d_navigator/MoveToPosition2DFeedback"; };
