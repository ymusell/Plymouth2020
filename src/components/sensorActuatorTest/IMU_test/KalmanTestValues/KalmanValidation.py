...
ax1.plot(time,mYaw_3,'r', label='Kalman avec vecteur de 3 dimensions')
ax1.plot(time,mYaw_2,'b', label='Kalman avec vecteur de 2 dimensions')
ax1.legend()
ax2 = fig.add_subplot(222)
ax2.set_title("Pitch in relation to the time")
ax2.plot(time,mPitch_3,'r', label='Kalman avec vecteur de 3 dimensions')
ax2.plot(time,mPitch_2,'b', label='Kalman avec vecteur de 2 dimensions')
ax2.legend()
ax3 = fig.add_subplot(223)
ax3.set_title("Roll in relation to the time")
ax3.plot(time,mRoll_3,'r', label='Kalman avec vecteur de 3 dimensions')
ax3.plot(time,mRoll_2,'b', label='Kalman avec vecteur de 2 dimensions')
ax3.legend()
